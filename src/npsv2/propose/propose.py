...
def propose_vcf(cfg, vcf_path: str, output_path: str, repeats_bed_path: str):
        ...
        with pysam.VariantFile(output_path, mode="w", header=dst_header) as dst_vcf_file:
            ...
            for record in src_vcf_file:
                ...
                for repeat in repeats:
                    ...
                    repeat_end = int(repeat[2]) + cfg.refine.peak_finding_flank - length_change
                    ...
                    for peak in peaks:
                        ...
                        if cfg.refine.all_alignments:
                            alt_end = peak + repeat_start + length_change
                        else:
